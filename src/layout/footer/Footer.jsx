        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
          ...
          <div>
            ...
            <div className='flex items-center gap-2 w-60 py-1'>
              ...
              <p className='leading-7 font-normal text-lg text-white m-0 break-words'>4102 Lynn Avenue, Las Vegas, NM, USA</p>
            </div>
            <div className='flex items-center gap-2 py-1'>
              {Icons.emialIcon}
              <p className='leading-7 font-normal text-lg text-white m-0 break-words'>0devdesign.studio@gmail.com</p>
            </div>
            <div className='flex items-center gap-2 py-1'>
              {Icons.callIcon}
              <p className='leading-7 font-normal text-lg text-white m-0 break-words'>+1 516 231 1313</p>
            </div>
            <div className="flex justify-start gap-4 mt-4 items-center justify-start">
              <Link to="/" className="cursor-pointer rounded-md">{Icons.fbIcon}</Link>
      ...
      <div className='border-t-2 border-on-primary-opacity-0.12 mt-12 py-10'>
        <div className='container text-center lg:text-left mx-auto px-4'>
          <div className='flex flex-col gap-y-4 lg:flex-row justify-between'>
            <div className='text-white text-base font-normal leading-6'> © 2022 Dev Charity |
            ...
            <div className='text-white text-base font-normal leading-6'> Marketing & Web Design by
              <Link to="#" className='text-tertiary'> Devdesign Studio</Link></div>
          </div>
        </div>
      </div>
