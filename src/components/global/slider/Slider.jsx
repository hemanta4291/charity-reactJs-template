...
const Slider = () => {
  return (
        <div style={{backgroundImage: `url(${sliderImg})`}} className="h-155 lg:h-237 flex items-center bg-cover bg-no-repeat bg-center">
            <div className='container mx-auto'>
                <div className='max-w-2xl text-white px-4 text-center lg:text-left'>
                    ...
                    <div className='mt-6 flex items-center gap-x-2 sm:gap-x-8 justify-center lg:justify-start'>
